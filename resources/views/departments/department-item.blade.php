            ...
            <div class="row g-0 align-items-center">
                <div class="col-xs-12 col-md-2 align-middle text-center p-2">
                    @if ( $data_item->logo_image != null )
                        <img width="42" height="42" class="ml-2 img-fluid text-center rounded-circle p-1 border" src="{{ route('fc.get-dept-picture', $data_item->id) }}" />
                    @else
                        <div class="ml-2 fm-icon-box radius-15 bg-primary text-white text-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @if (isset($data_item->telephone) && empty($data_item->telephone) == false)
                                <span class="card-text small"><i class="fa fa-phone-square gray-200"></i> {!! $data_item->telephone !!}</span>
                            @endif

                            @if (isset($data_item->email) && empty($data_item->email) == false)
                                <span class="card-text small"><i class="fa fa-envelope gray-200"></i> {!! $data_item->email !!}</span>
                            @endif
