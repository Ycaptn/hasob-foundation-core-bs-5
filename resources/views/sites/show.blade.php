    ...
    <div class="card-body">
        <div class="tab-struct  custom-tab-1">
            <ul role="tablist" class="nav nav-tabs nav-primary" id="myTab">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="menu-tab" data-bs-toggle="tab" data-bs-target="#site_menu" href="#menu" role="tab" aria-controls="site_menu" aria-selected="false">Menu</a>
                </li>
                <li class="nav-item">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-15">
                                            <a id="btn-site-add-component" href="#" class="float-end btn btn-primary btn-sm btn-new-mdl-component-modal" data-bs-toggle="tooltip" title="Add New Component" style=""><span class="fa fa-plus-square mr-5"></span> Add New Component</a>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <!-- <div class="card-wrapper collapse in"> -->
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-15">
                                            <a id="btn-site-add-menu" href="#" class="float-end btn btn-primary btn-sm btn-new-mdl-menu-modal" data-bs-toggle="tooltip" title="Add New Menu" style=""><span class="fa fa-plus-square mr-5"></span> Add New Menu</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 mb-15">
                            ...
                            <!-- <div class="card-wrapper collapse in"> -->
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-15">
                                            <a id="btn-site-add-template" href="#" class="float-end btn btn-primary btn-sm btn-new-mdl-template-modal" data-bs-toggle="tooltip" title="Add New Template" style=""><span class="fa fa-plus-square mr-5"></span> Add New Template</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 mb-15">
