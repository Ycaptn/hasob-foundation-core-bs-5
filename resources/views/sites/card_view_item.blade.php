        ...
        <div class="row g-0">
            <div class="col-lg-1 text-center">
                ...
                <a href="{{ route('fc.sites.show', $data_item->id) }}">
                    <i class="fa fa-3x fa-paper-plane-o mt-4 ms-3 fs-2"></i>
                </a>
                <!-- </center> -->
            </div>
            <div class="col-lg-11">
                    ...
                    <div class="d-lg-flex align-items-center">
                        <div>
                            <h4 class="card-title mb-0"><a
                                    href="{{ route('fc.sites.show', $data_item->id) }}">{{ $data_item->site_name }}</a>
                            </h4>
                        </div>
                        <div class="ms-auto float-end">
                            <a data-bs-toggle="tooltip" title="view" data-val="{{ $data_item->id }}"
                                ...
                                class="btn-show-mdl-site-modal inline-block me-2" href="#">
                                <i class="fa fa-files-o txt-primary" style="opacity:80%"></i>
                            </a>

                            @if (\Auth::user() != null && \Auth::user()->hasAnyRole('admin', 'department-admin'))
                                <a data-bs-toggle="tooltip" title="Edit" data-val="{{ $data_item->id }}"
                                    data-bs-toggle="tooltip" data-original-title="Edit"
                                    class="btn-edit-mdl-site-modal inline-block me-2" href="#">
                                    <i class="bx bxs-edit txt-warning" style="opacity:80%"></i>
                                </a>
                                <a data-bs-toggle="tooltip" title="Delete" data-val="{{ $data_item->id }}"
                                    data-bs-toggle="tooltip" data-original-title="Delete"
                                    class="btn-delete-mdl-site-modal inline-block me-2" href="#">
