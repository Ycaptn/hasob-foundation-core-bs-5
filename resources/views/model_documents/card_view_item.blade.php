...
<div class="col-12 col-md-12 col-sm-12">
    <div class="card">
        @php
            $detail_page_url = route('fc.modelDocuments.show', $data_item->id);
        @endphp
        <div class="row g-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto"> 
                        <a data-toggle="tooltip" 
                            ...
                            class="btn-edit-mdl-modelDocument-modal me-1" href="#">
                            <i class="bx bxs-edit"></i>
                        </a>
                        <a data-toggle="tooltip" 
                            title="Delete" 
                            data-val='{{$data_item->id}}' 
                            class="btn-delete-mdl-modelDocument-modal me-1" href="#">
