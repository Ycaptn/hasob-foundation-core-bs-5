...
<li class="">
    <a href="{{ route('fc.departments.index') }}" class="{{ Request::is('fc/departments') ? 'active' : '' }}">
        <div class="float-start"><i class="zmdi zmdi-group me-10"></i><span class="right-nav-text">Departments</span></div><div class="float-end"></div><div class="clearfix"></div>
    </a>
</li>
@endif
...
<li class="">
    <a href="{{ route('fc.ledgers.index') }}" class="{{ Request::is('fc/ledgers') ? 'active' : '' }}">
        <div class="float-start"><i class="zmdi zmdi-bookmark-outline me-10"></i><span class="right-nav-text">Ledgers</span></div><div class="float-end"></div><div class="clearfix"></div>
    </a>
</li>
@endif
...
<li>
    <a href="javascript:void(0);" data-toggle="collapse" data-target="#access_dr" class="collapsed" aria-expanded="false">
        <div class="float-start"><i class="zmdi zmdi-accounts-list me-10"></i>
    ...
    <ul id="access_dr" class="collapse-level-1 collapse" aria-expanded="false" style="">
        ...
        <li class="">
            <a href="{{ route('fc.users.index') }}" class="{{ Request::is('fc/users') ? 'active' : '' }}">
                <div class="float-start"><i class="zmdi zmdi-accounts-outline me-10"></i><span class="right-nav-text">Users</span></div><div class="float-end"></div><div class="clearfix"></div>
            </a>
        </li>
        <li class="">
            <a href="{{ route('fc.user.show',0) }}" class="{{ Request::is('fc/user/0') ? 'active' : '' }}">
                <div class="float-start"><i class="zmdi zmdi-account-add me-10"></i><span class="right-nav-text">Add User</span></div><div class="float-end"></div><div class="clearfix"></div>
            </a>
        </li>
        <li class="">
            <a href="{{ route('fc.roles.index') }}" class="{{ Request::is('fc/roles*') ? 'active' : '' }}">
                <div class="float-start"><i class="zmdi zmdi-gamepad me-10"></i><span class="right-nav-text">Roles</span></div><div class="float-end"></div><div class="clearfix"></div>
            </a>
        </li>
...
<li>
    <a href="javascript:void(0);" data-toggle="collapse" data-target="#settings_dr" class="collapsed" aria-expanded="false">
        <div class="float-start"><i class="zmdi zmdi-wrench me-10"></i>
    ...
    <ul id="settings_dr" class="collapse-level-1 collapse" aria-expanded="false" style="">
        ...
        <li class="">
            <a href="{{ route('fc.org-settings') }}" class="{{ Request::is('fc/org-settings') ? 'active' : '' }}">
                <div class="float-start"><i class="zmdi zmdi-settings me-10"></i><span class="right-nav-text">Settings</span></div><div class="float-end"></div><div class="clearfix"></div>
            </a>
        </li>

        <li class="">
            <a href="{{ route('fc.org-domains') }}" class="{{ Request::is('fc/org-domains') ? 'active' : '' }}">
                <div class="float-start"><i class="zmdi zmdi-seat me-10"></i><span class="right-nav-text">Domains</span></div><div class="float-end"></div><div class="clearfix"></div>
            </a>
        </li>

        <li class="">
            <a href="{{ route('fc.org-features') }}" class="{{ Request::is('fc/org-features') ? 'active' : '' }}">
                <div class="float-start"><i class="zmdi zmdi-apps me-10"></i><span class="right-nav-text">Features</span></div><div class="float-end"></div><div class="clearfix"></div>
            </a>
        </li>
