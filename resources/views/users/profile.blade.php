...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            @include(
                'hasob-foundation-core::users.partials.user-badge'
            )
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-top border-0 border-4 border-success">
                ...
                <div class="card-body">
                        ...
                        <div class="ms-auto">
                            @if ($edit_mode == false)
                                <a href="{{ route('fc.users.profile', 'edit=1') }}">
                                    ...
                                    <button id="btn-add"
                                        class="btn btn-sm btn btn-outline-primary mt-1 me-2 py-1  px-1 small">
                    ...
                    @if ($edit_mode == false)
                        @include(
                            'hasob-foundation-core::users.partials.user-display'
                        )
                    @else
                        @include(
                            'hasob-foundation-core::users.partials.user-detail'
                        )

                        <div class="col-xs-9 col-xs-offset-3 card-text mt-3">
                            <button data-val="{{ Auth::id() }}" type="button" class="btn btn-primary" id="save"> <span
