<form id="frmUserDetails" name="frmUserDetails" class="form-horizontal" novalidate="">
    ...
    <div id="errorMsgUserDetails" class="alert alert-danger alert-dismissible fade show" role="alert"
        style="display: none;">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-lg-12">
                        <div class="{{ $errors->has('emailAddress') ? ' has-error' : '' }}">
                            <div class="input-group">
                                <span class="input-group-text bg-transparent"><i
                                        class="bx bxs-envelope-open"></i></span>
                                <input type='text' class="form-control" id="emailAddress" name="emailAddress" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="{{ $errors->has('password1_confirmation') ? ' has-error' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" id="password1_confirmation"
                                    name="password1_confirmation" placeholder="Re-enter Password" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="{{ $errors->has('jobTitle') ? ' has-error' : '' }}">
                            <div class="input-group">
                                ...
                                <input type='text' class="form-control" id="jobTitle" name="jobTitle"
                                    placeholder="Job Title i.e. Director, etc." />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-9">
                            @foreach ($allRoles as $idx => $role)
                                <div class="col-xs-6">
                                    <div class="checkbox">
                                        <label>
                                            <input id='userRole{{ $role->name }}'
                                                name='userRole{{ $role->name }}' type="checkbox" value="0"
                                                class="roleCbx form-check-input" /> {{ $role->name }}
                                        </label>
                                    </div>
                                </div>
                            @endforeach
