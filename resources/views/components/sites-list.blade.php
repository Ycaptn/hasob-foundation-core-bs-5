                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <a href="{{ route('fc.sites.show', $item->id) }}">
                                <i class="fa fa-3x fa-globe me-10"></i>
                            </a>
                        </div>
                        <div class="col-lg-10">
                            ...
                            <a href="#" class="float-end">
                                <i class="fa fa-edit font-15 pe-3 text-primary" data-toggle="tooltip" title=""
                                    data-original-title="Edit"></i>
                                <i class="fa fa-files-o font-15 pe-3 text-warning" data-toggle="tooltip" title=""
                                    data-original-title="Pages"></i>
                                <i class="fa fa-trash font-15 pe-3 text-danger" data-toggle="tooltip" title=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="div-site-modal-error" class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <form class="form-horizontal" id="frm-site-modal" role="form" method="POST"
                                ...
                                <div class="col-lg-12 ma-10">
                                    ...
                                    <div id="div-edit-txt-site-primary-id">
                                        <div class="row">
                                            <div class="col-lg-10 ma-10">
                                                @include(
                                                    'hasob-foundation-core::sites.fields'
                                                )
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="btn-save-mdl-site-modal"
