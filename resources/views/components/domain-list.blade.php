                                ...
                                <tr>
                                    <td width="30%">
                                        <a href="javascript:void(0)"
                                            class="pe-5 text-primary btn-edit-mdl-organization-modal"
                                            data-val="{{ $item->id }}" data-toggle="tooltip" title=""
                                            data-original-title="Edit" aria-describedby="tooltip563536">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0)"
                                            class="pe-10 text-primary btn-delete-mdl-organization-modal"
                                            data-val="{{ $item->id }}" data-toggle="tooltip" title=""
                                            data-original-title="Delete" aria-describedby="tooltip563">
...
<div class="modal fade" id="mdl-organization-modal" tabindex="-1" role="dialog"
    aria-labelledby="mdl-department-modal" aria-hidden="true">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if (result.errors) {
                                    $('#spinner').hide();
                                    $('.btn-delete-mdl-organization-modal').attr(
                                        "disabled", false);
            ...
            $('#btn-save-mdl-organization-modal').click(function(e) {
                ...
                formData.append('is_local_default_organization', $('#is_local_default_organization').is(
                    ':checked') ? 1 : 0);
                    ...
                    success: function(result) {
                        if (result.errors) {
                            ...
                            $.each(result.errors, function(key, value) {
                                $('#div-organization-modal-error').append(
                                    '<li class="">' + value + '</li>');
                            });
                        } else {
                            $('#div-organization-modal-error').hide();
