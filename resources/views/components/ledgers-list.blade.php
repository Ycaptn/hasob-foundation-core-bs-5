                            ...
                            @foreach ($ledgers as $item)
                                <tr>
                                    <td width="50%">
                                        ...
                                        <a href="javascript:void(0)" class="pe-10 text-primary btn-edit-mdl-ledger-modal"
                                            data-bs-toggle="tooltip" data-val="{{ $item->id }}" title=""
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="frm-ledger-modal" role="form" method="POST"
                    ...
                    success: function(result) {
                        if (result.errors) {
                            ...
                            $.each(result.errors, function(key, value) {
                                ...
                                $('#div-ledger-modal-error').append('<li class="">' +
                                    value + '</li>');
                            });
                        } else {
                            $('#div-ledger-modal-error').hide();
