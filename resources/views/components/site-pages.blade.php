                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-15">
                            ...
                            <a id="btn-site-options" href="#" class="text-primary" data-toggle="tooltip"
                                title="Site Settings" style=""><span class="fa fa-cogs me-2"></span></a>
                            <a id="btn-site-add-page" href="#" class="text-primary btn-new-mdl-page-modal"
                                data-toggle="tooltip" title="Add Page" style=""><span
                                    class="fa fa-file-text-o me-2"></span></a>
                            <a id="btn-site-delete" href="#" class="text-primary" data-toggle="tooltip"
                                title="Delete Site" style=""><span class="fa fa-trash me-2"></span></a>
                            <a id="btn-site-rename" href="#" class="text-primary" data-toggle="tooltip"
                                title="Rename Site" style=""><span class="fa fa-edit me-2"></span></a>
                                        ...
                                        @foreach ($site->pages as $item)
                                            <tr>
                                                <td width="50%">
                                                    ...
                                                    <a href="javascript:void(0)" class="pe-5 text-danger"
                                                        data-toggle="tooltip" title="" data-original-title="Delete"
                                                        aria-describedby="">
                                                        <i class="fa fa-times"></i>
                                                    </a>
                                                    <a href="javascript:void(0)"
                                                        class="pe-5 text-success btn-edit-mdl-page-editor-modal"
                                                        data-val="{{ $item->id }}" data-toggle="tooltip" title=""
                                                        data-original-title="Edit" aria-describedby="tooltip563536">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" id="frm-page-modal" role="form" method="POST"
                    ...
                    success: function(result) {
                        if (result.errors) {
                            ...
                            $.each(result.errors, function(key, value) {
                                $('#div-page-modal-error').append('<li class="">' +
                                    value + '</li>');
                            });
                        } else {
                            $('#div-page-modal-error').hide();
