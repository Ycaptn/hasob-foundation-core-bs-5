...
<div class="col-12 col-md-12 col-sm-12">
    <div class="card">
        @php
            $detail_page_url = route('attendance.reactions.show', $data_item->id);
        @endphp
        <div class="row g-0">
                ...
                <div class="d-flex align-items-center">
                    @if ( $data_item->logo_image != null )
                        <a href='{{$detail_page_url}}'>
                            <img width="42" height="42" class="ms-2 img-fluid text-center rounded-circle p-1 border" src="{{ route('attendance.get-dept-picture', $data_item->id) }}" />
                        </a>
                    @else
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto"> 
                        <a data-toggle="tooltip" 
                            ...
                            class="btn-edit-mdl-reaction-modal" href="#">
                        ...
                        <a data-toggle="tooltip" 
                            title="Delete" 
                            data-val='{{$data_item->id}}' 
                            class="btn-delete-mdl-reaction-modal me-2" href="#">
                            <i class="bx bx-x"></i>
                        </a>
                        @endif
                    </div>
