{{--    
    <a href="#" data-val='{{$id}}' class='btn-show-mdl-reaction-modal'>
        {!! Form::button('<i class="fa fa-eye"></i>', ['type'=>'button']) !!}
    </a>
    
    <a href="#" data-val='{{$id}}' class='btn-edit-mdl-reaction-modal'>
        {!! Form::button('<i class="fa fa-edit"></i>', ['type'=>'button']) !!}
    </a>
    
    <a href="#" data-val='{{$id}}' class='btn-delete-mdl-reaction-modal'>
...
<div class='btn-group' role="group">
    <a data-toggle="tooltip" 
        title="View" 
        data-val='{{$id}}' 
        class="btn-show-mdl-reaction-modal" href="#">
    ...
    <a data-toggle="tooltip" 
        title="Delete" 
        data-val='{{$id}}' 
        class="btn-delete-mdl-reaction-modal" href="#">
