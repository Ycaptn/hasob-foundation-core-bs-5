...
<a class="ms-1" href="{{ route('disabledItems.index') }}">
...
@section('page_title_buttons')
    ...
    <a data-toggle="tooltip" 
        title="New" 
        data-val='{{$id}}' 
        class="btn btn-primary btn-new-mdl-disabledItem-modal" href="#">
    ...
    <a data-toggle="tooltip" 
        title="Edit" 
        data-val='{{$id}}' 
        class="btn btn-primary btn-edit-mdl-disabledItem-modal" href="#">
