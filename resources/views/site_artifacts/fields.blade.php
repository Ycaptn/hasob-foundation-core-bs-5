...
<div id="div-headline" class="mb-3">
    <label class="form-label" for="headline">Name</label>
    <div class="col">
...
<div id="div-content" class="mb-3">
    ...
    <div class="col">
        <textarea id="content" class="form-control" rows="5" placeholder="Contents ... "></textarea>
        {{-- {!! Form::textarea('content', null, ['class' => 'form-control','minlength' => 0,'maxlength' => 2000]) !!} --}}
    </div>
</div>
