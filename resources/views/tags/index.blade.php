...
<a id="btn-new-mdl-tag-modal" class="btn btn-primary btn-new-mdl-tag-modal">
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                @include('hasob-lab-manager-module::pages.tags.table')
    ...
    @include('hasob-lab-manager-module::pages.tags.modal')
