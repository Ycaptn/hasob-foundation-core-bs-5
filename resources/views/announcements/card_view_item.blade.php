                            ...
                            <div class="col-xs-12 pa-10">
                                ...
                                <div class="float-start">
                                    ...
                                    <div class="float-start user-detail-wrap pt-5">	
                                        @php
                                            $detail_page_url = route('fc.annoucements.show', $data_item->id);
                                        @endphp
                                ...
                                <div class="float-end pt-5">
                                    <a data-toggle="tooltip" 
                                        ...
                                        class="btn-edit-mdl-annoucement-modal inline-block me-2" href="#">
                                    ...
                                    <a data-toggle="tooltip" 
                                        title="Delete" 
                                        data-val='{{$data_item->id}}' 
                                        class="btn-delete-mdl-annoucement-modal inline-block me-2" href="#">
