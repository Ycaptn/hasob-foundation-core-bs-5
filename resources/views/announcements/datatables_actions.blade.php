...
<a data-toggle="tooltip" title="View" data-val='{{ $id }}' class="btn-show-mdl-announcement-modal inline-block me-2"
    href="#">
    <i class="zmdi zmdi-eye txt-primary" style="opacity:80%"></i>
</a>

<a data-toggle="tooltip" title="Edit" data-val='{{ $id }}' class="btn-edit-mdl-announcement-modal inline-block me-2"
    href="#">
    <i class="zmdi zmdi-border-color txt-warning" style="opacity:80%"></i>
</a>

<a data-toggle="tooltip" title="Delete" data-val='{{ $id }}'
    class="btn-delete-mdl-announcement-modal inline-block me-2" href="#">
