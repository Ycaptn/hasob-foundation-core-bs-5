...
@section('page_title_buttons')
    ...
    @if (Auth()->user()->hasAnyRole(['', 'admin']))
        @include(
            'hasob-foundation-core::pages.relationships.bulk-upload-modal'
        )
    @endif
@stop
...
@section('page_title_subtext')
    <a class="ms-10 mb-10" href="{{ route('fc.relationships.index') }}" style="font-size:11px;color:blue;">
...
@section('content')
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body">
            ...
            @include(
                'hasob-foundation-core::pages.relationships.show_fields'
            )
