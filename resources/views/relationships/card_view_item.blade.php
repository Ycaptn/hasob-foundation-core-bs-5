        ...
        <div class="col-md-9">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h4 class="card-title"><a href='{{ $detail_page_url }}'>{{ $data_item->id }}</a></h4>
                    </div>
                    <div class="ms-auto">
                        <a data-toggle="tooltip" title="Edit" data-val='{{ $data_item->id }}'
                            class="btn-edit-mdl-relationship-modal inline-block me-2" href="#">
                            <i class="bx bxs-edit txt-warning" style="opacity:80%"></i>
                        </a>

                        <a data-toggle="tooltip" title="Delete" data-val='{{ $data_item->id }}'
                            class="btn-delete-mdl-relationship-modal inline-block me-2" href="#">
