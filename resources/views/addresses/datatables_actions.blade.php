...
<a data-toggle="tooltip" title="View" data-val='{{ $id }}' class="btn-show-mdl-address-modal inline-block me-2"
    href="#">
    <i class="zmdi zmdi-eye txt-primary" style="opacity:80%"></i>
</a>

<a data-toggle="tooltip" title="Edit" data-val='{{ $id }}' class="btn-edit-mdl-address-modal inline-block me-2"
    href="#">
