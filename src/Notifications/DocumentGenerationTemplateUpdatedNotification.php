...
class DocumentGenerationTemplateUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('DocumentGenerationTemplate updated successfully')
                                ->markdown(
                                    'mail.documentGenerationTemplates.updated',
