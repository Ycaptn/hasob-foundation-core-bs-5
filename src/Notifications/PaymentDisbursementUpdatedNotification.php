...
class PaymentDisbursementUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('PaymentDisbursement updated successfully')
                                ->markdown(
                                    'mail.paymentDisbursements.updated',
