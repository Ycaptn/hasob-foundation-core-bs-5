...
class PaymentDisbursementCreatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('PaymentDisbursement created successfully')
                                ->markdown(
                                    'mail.paymentDisbursements.created',
