...
class DocumentGenerationTemplateDeletedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('DocumentGenerationTemplate deleted successfully')
                                ->markdown(
                                    'mail.documentGenerationTemplates.deleted',
