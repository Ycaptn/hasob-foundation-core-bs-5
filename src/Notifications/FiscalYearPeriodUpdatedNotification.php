...
class FiscalYearPeriodUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('FiscalYearPeriod updated successfully')
                                ->markdown(
                                    'mail.fiscalYearPeriods.updated',
