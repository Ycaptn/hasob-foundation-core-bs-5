...
class LedgerReconciliationCreatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('LedgerReconciliation created successfully')
                                ->markdown(
                                    'mail.ledgerReconciliations.created',
