...
class LedgerTransferUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('LedgerTransfer updated successfully')
                                ->markdown(
                                    'mail.ledgerTransfers.updated',
