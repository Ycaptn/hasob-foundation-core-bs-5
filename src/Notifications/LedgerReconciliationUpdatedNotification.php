...
class LedgerReconciliationUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('LedgerReconciliation updated successfully')
                                ->markdown(
                                    'mail.ledgerReconciliations.updated',
