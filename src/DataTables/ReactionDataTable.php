...
class ReactionDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-foundation-core::pages.reactions.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Reaction $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Reaction $model)
    {
    ...
    {
        return 'reactions_datatable_' . time();
    }
}
