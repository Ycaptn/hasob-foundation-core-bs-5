...
class LedgerTransferDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-lab-manager-module::pages.ledger_transfers.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\LedgerTransfer $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(LedgerTransfer $model)
    {
    ...
    {
        return 'ledger_transfers_datatable_' . time();
    }
}
