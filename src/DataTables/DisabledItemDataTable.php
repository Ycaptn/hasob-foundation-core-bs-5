...
class DisabledItemDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-lab-manager-module::pages.disabled_items.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DisabledItem $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DisabledItem $model)
    {
    ...
    {
        return 'disabled_items_datatable_' . time();
    }
}
