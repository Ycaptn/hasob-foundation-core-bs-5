...
class BudgetItemDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-lab-manager-module::pages.budget_items.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\BudgetItem $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BudgetItem $model)
    {
    ...
    {
        return 'budget_items_datatable_' . time();
    }
}
