...
class ModelDocumentDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-foundation-core::pages.model_documents.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ModelDocument $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ModelDocument $model)
    {
    ...
    {
        return 'model_documents_datatable_' . time();
    }
}
