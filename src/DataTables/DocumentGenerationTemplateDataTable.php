...
class DocumentGenerationTemplateDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-foundation-core::pages.document_generation_templates.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DocumentGenerationTemplate $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DocumentGenerationTemplate $model)
    {
    ...
    {
        return 'document_generation_templates_datatable_' . time();
    }
}
