...
class FiscalYearPeriodDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-lab-manager-module::pages.fiscal_year_periods.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\FiscalYearPeriod $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FiscalYearPeriod $model)
    {
    ...
    {
        return 'fiscal_year_periods_datatable_' . time();
    }
}
