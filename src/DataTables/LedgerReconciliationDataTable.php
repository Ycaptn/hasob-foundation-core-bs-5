...
class LedgerReconciliationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hasob-lab-manager-module::pages.ledger_reconciliations.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\LedgerReconciliation $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(LedgerReconciliation $model)
    {
    ...
    {
        return 'ledger_reconciliations_datatable_' . time();
    }
}
